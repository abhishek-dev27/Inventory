...
const ProductForm = ({ initialData = {}, onSubmit, loading = false, isEdit = false }) => {
  ...
  const handleGenerateSKU = () => {
    const prefix = getPrefix(formData.productType);
      ...
      >
        ...
        <div className="form-grid">
          ...
          <div>
            ...
            <Input
              name="sku"
              placeholder={isBattery ? 'e.g. BAT-10482' : isSpare ? 'e.g. SPR-90012' : isConsumable ? 'e.g. CON-89102' : isModule ? 'e.g. PNL-55014' : 'e.g. OGI-10024'}
              value={formData.sku}
          ...
          <div className="full-width">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
              ...
              {(isBattery || isInverter || isModule || isMCB || isConsumable || isSpare) && (
                <button
                  type="button"
